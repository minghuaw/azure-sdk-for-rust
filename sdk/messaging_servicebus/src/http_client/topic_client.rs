...
/// Client object that allows interaction with the ServiceBus topic API
#[derive(Debug, Clone)]
pub struct TopicSender {
    topic_client: TopicClient,
}

/// Client object that allows interaction with the ServiceBus subscription API
#[derive(Debug, Clone)]
...
impl TopicClient {
    ...
    /// Creates a new topic sender instance
    pub fn topic_sender(&self) -> TopicSender {
        TopicSender::new(self.clone())
    }

    /// Creates a new subscription receiver instance
